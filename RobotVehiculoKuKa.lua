function sysCall_init() 
    ...
    if (v<20412) then
        sim.displayDialog('Warning','The YouBot model is only fully supported from CoppeliaSim version 2.4.12 and above.&&nThis simulation will not run as expected!',sim.dlgstyle_ok,false,'',nil,{0.8,0,0,0,0,0})
    end
